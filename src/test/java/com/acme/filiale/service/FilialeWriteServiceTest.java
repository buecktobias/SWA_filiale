...
class FilialeWriteServiceTest {
    ...
    private final FilialeWriteService service = new FilialeWriteService(repo, validator);
    ...
    void update(final String id) {
        ...
        assertThat(result.get().getName()).isEqualTo(NEUER_NACHNAME);
    }
