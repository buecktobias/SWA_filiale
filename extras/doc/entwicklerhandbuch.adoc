...
.Use Cases für den Microservice "filiale"
...
.Komponenten des Microservice "filiale"
...
----
include::./FilialeGetController.plantuml[]
----
...
----
include::./FilialeReadService.plantuml[]
----
...
.Die Entity-Klasse "Filiale" für Filialedaten
[plantuml,Kunde,svg]
----
include::./Filiale.plantuml[]
----
