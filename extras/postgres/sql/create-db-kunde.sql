...
CREATE ROLE filiale LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE kunde;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE filiale TO filiale;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE filialespace OWNER filiale LOCATION '/var/lib/postgresql/tablespace/filiale';
